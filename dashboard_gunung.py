...
# Load MLP tanpa compile untuk menghindari error mse
...
# ===============================
# 5️⃣ Buat User Input Dictionary
# ===============================
user_input = {
...
for idx, row in top_gunung.iterrows():
    ...
    st.markdown(f"[Buka {row['Name']} di Google Maps]({maps_url})")

# ===============================
# 9️⃣ Map Interaktif dengan Pydeck
# ===============================
